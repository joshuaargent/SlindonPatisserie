    ...
    <div className="min-h-screen bg-[#F7F2E9]">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          {/* Payment Info */}
          <div className="mt-6 p-4 bg-[#F7F2E9] border border-[#E8DDD0] rounded-lg text-center">
            <p className="text-[#6B5344]">
              <strong>Payment:</strong> Pay by card, cash, or contactless when you collect your order.
            </p>
          </div>
        </div>
      </div>
