...
export default function TermsPage() {
  return (
    <div className="bg-[#FDF8F0]">
      {/* Hero */}
      <section className="bg-[#2D1810] text-[#FDF8F0] py-16">
        <div className="container">
          ...
          <p className="mt-4 text-[#F5EDE0]/80">
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">1. General</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">2. Products & Orders</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">3. Collection & Delivery</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">4. Wholesale Terms</h2>
            <p className="text-[#5C4033]">
              Wholesale accounts are subject to separate terms and conditions. Please 
              contact us for details on our wholesale agreement.
            </p>

            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">5. Franchise</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">6. Website Use</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">7. Intellectual Property</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">8. Liability</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">9. Changes to Terms</h2>
            <p className="text-[#5C4033]">
              We may update these terms at any time. Continued use of the website 
              constitutes acceptance of any changes.
            </p>

            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">10. Contact</h2>
            <p className="text-[#5C4033]">
              For questions about these terms, please contact us:
            </p>
            <ul className="list-none space-y-2 text-[#5C4033] mt-4">
