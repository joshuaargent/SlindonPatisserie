            ...
            {marketSchedule.map((market, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="h-14 w-14 rounded-full bg-[#D4A574]/20 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-[#D4A574] font-medium mt-1">{market.day}</p>
                  </div>
                </div>
                <div className="mt-6 space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[#5C4033]">{market.time}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <MapPin className="h-5 w-5 text-[#6B5B4F] shrink-0 mt-0.5" />
                    <div>
                      <p className="text-[#5C4033]">{market.location}</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
            <div className="text-center">
              <div className="h-12 w-12 rounded-full bg-[#8B4513] mx-auto mb-4 flex items-center justify-center">
                <span className="text-white font-bold text-xl">1</span>
              </div>
              <h3 className="font-semibold text-[#2D1810] mb-2">Browse</h3>
              <p className="text-[#5C4033] text-sm">Explore our full range of fresh products</p>
            </div>
            <div className="text-center">
              <div className="h-12 w-12 rounded-full bg-[#8B4513] mx-auto mb-4 flex items-center justify-center">
                <span className="text-white font-bold text-xl">2</span>
              </div>
              <h3 className="font-semibold text-[#2D1810] mb-2">Choose</h3>
              <p className="text-[#5C4033] text-sm">Select your favorites from our selection</p>
            </div>
            <div className="text-center">
              <div className="h-12 w-12 rounded-full bg-[#8B4513] mx-auto mb-4 flex items-center justify-center">
                <span className="text-white font-bold text-xl">3</span>
              </div>
              <h3 className="font-semibold text-[#2D1810] mb-2">Pay</h3>
              <p className="text-[#5C4033] text-sm">Cash and card accepted at all markets</p>
            </div>
            <div className="text-center">
              <div className="h-12 w-12 rounded-full bg-[#8B4513] mx-auto mb-4 flex items-center justify-center">
                <span className="text-white font-bold text-xl">4</span>
              </div>
              <h3 className="font-semibold text-[#2D1810] mb-2">Enjoy!</h3>
              <p className="text-[#5C4033] text-sm">Take your treats home and enjoy!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['Croissants', 'Bread', 'Cakes', 'Pastries', 'Sourdough', 'Muffins', 'Cookies', 'Seasonal Specials'].map((item, index) => (
              <div key={index} className="bg-white rounded-xl p-4 text-center border border-[#E8DDD0]">
                <p className="text-[#8B4513] font-medium">{item}</p>
              </div>
            ))}
          </div>
        </div>
