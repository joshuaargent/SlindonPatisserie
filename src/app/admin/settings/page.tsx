  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-[#6B5344] mt-1">Configure your store settings and integrations</p>
      </div>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 bg-[#F7F2E9] rounded-lg flex items-center justify-center">
                  <Icon className="w-6 h-6 text-[#6B5344]" />
                </div>
                <div>
                  <h3 className="font-semibold text-[#3A2C2A]">{section.title}</h3>
                  <span className="text-xs text-[#8B1E22] font-medium">Coming Soon</span>
                </div>
              </div>
              <p className="text-sm text-[#6B5344]">{section.description}</p>
            </div>
          )
        })}
      </div>
