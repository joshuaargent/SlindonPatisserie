      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">1. Information We Collect</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">2. How We Use Your Information</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">3. Data Security</h2>
            <p className="text-[#5C4033]">
              We implement appropriate security measures to protect your personal information 
              against unauthorized access, alteration, disclosure, or destruction.
            </p>

            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">4. Cookies</h2>
            <p className="text-[#5C4033]">
              Our website may use cookies to enhance your browsing experience. You can 
              control cookie settings through your browser preferences.
            </p>

            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">5. Your Rights</h2>
            <p className="text-[#5C4033]">
            ...
            <h2 className="font-serif text-2xl font-bold text-[#2D1810] mt-8 mb-4">6. Contact Us</h2>
            <p className="text-[#5C4033]">
