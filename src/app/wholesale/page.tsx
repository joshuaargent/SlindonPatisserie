          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <div className="h-8 w-8 rounded-full bg-[#D0A246]/20 flex items-center justify-center shrink-0">
                    <CheckCircle className="h-5 w-5 text-[#8B1E22]" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-[#3A2C2A]">Handmade Daily</h3>
                    <p className="text-[#6B5344] text-sm">Every product is made fresh each day by our skilled bakers</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="h-8 w-8 rounded-full bg-[#D0A246]/20 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#3A2C2A]">Competitive Pricing</h3>
                    <p className="text-[#6B5344] text-sm">Special wholesale rates for registered businesses</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="h-8 w-8 rounded-full bg-[#D0A246]/20 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#3A2C2A]">Flexible Ordering</h3>
                    <p className="text-[#6B5344] text-sm">Regular standing orders or one-off purchases</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="h-8 w-8 rounded-full bg-[#D0A246]/20 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#3A2C2A]">Reliable Delivery</h3>
                    <p className="text-[#6B5344] text-sm">Daily delivery to your door in temperature-controlled vehicles</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-[#E8DDD0] shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                <Building2 className="h-8 w-8 text-[#8B1E22]" />
                <h3 className="font-serif text-2xl font-bold text-[#3A2C2A]">
                  We Supply
                </h3>
              </div>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-center gap-3">
                    <span className="h-2 w-2 rounded-full bg-[#D0A246]"></span>
                    <span className="text-[#6B5344]">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-[#8B1E22] px-6 py-3 text-base font-medium text-[#8B1E22] transition-colors hover:bg-[#8B1E22] hover:text-white"
              >
