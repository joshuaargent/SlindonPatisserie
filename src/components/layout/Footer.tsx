      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 md:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <Link
              href="/products"
              className="inline-flex items-center justify-center gap-2 bg-[#D0A246] hover:bg-[#E0B256] text-[#3A2C2A] px-6 py-3 rounded-lg font-semibold transition-all duration-200 shadow-sm hover:shadow-md mt-4"
            >
            ...
            <div className="mt-6 flex items-center gap-2">
              <a
                ...
                className="text-white hover:text-[#D0A246] p-2 transition-colors"
                aria-label="YouTube"
              >
            ...
            <ul className="mt-4 space-y-3">
              {footerNav.main.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-white hover:text-[#D0A246] transition-colors font-medium"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${siteConfig.phone}`} className="text-white hover:text-[#D0A246] transition-colors font-medium">
                  {siteConfig.phone}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-[#D0A246] shrink-0" />
                <a href={siteConfig.links.email} className="text-white hover:text-[#D0A246] transition-colors font-medium">
                  Email Us
                </a>
              </li>
            </ul>
